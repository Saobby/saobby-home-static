    ...
    l.onreadystatechange = function() {
        if (4 == l.readyState) {
            ...
            if (e.success) {
                ...
                update_highlight(gebi("comment-area"));
                pasteToUpload.init();
            } else
