...
mdr.image = function(e, t, n) {
    var d = Math.random();
    return `<img src_="${rsc(e)}" alt="${rsc(n)}" title="${rsc(t) || ""}" class="marked-img" id="marked-img-${d}" hidden><a onclick="show_image(gebi('marked-img-${d}'));this.hidden=true;" href="javascript:;">点击加载外部图片</a>`
}
,
