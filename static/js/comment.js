...
<div id="comment-window-${e.cid}" hidden>
    ...
    <button class="wux-btn wux-btn-primary wux-btn-outline" onclick="document.getElementById('comment-window-${e.cid}').hidden=!0;document.getElementById('reply-btn-${e.cid}').disabled=!1;" type="button">取消</button>
