import { get_element_abs_pos_center, gen_continuous_random, gen_randint } from "./util.js";
...
export function make_splash(element){
    var pos = get_element_abs_pos_center(element);
    var assets_pool = [
        "https://www.saobby.com/static/image/particle/tera.webp",
        "https://www.saobby.com/static/image/particle/cat.webp",
        "https://www.saobby.com/static/image/particle/giga.webp",
        "https://www.saobby.com/static/image/particle/gobo.webp",
        "https://www.saobby.com/static/image/particle/nano.webp",
        "https://www.saobby.com/static/image/particle/pico.webp"
    ];
    for (var i=0; i<10; i++){
