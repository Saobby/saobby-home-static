    ...
    extensions: [
      {
        ...
        renderer(token) {
          if (token.kind === "checkbox") {
            ...
            return `<span style="background-color:#000;cursor:pointer;" title="剧透内容,点击显示 Spoilers.Click to reveal" onclick="this.style.backgroundColor='rgba(255,255,255,0)';this.title='';this.style.cursor='text';">${rsc(token.text)}</span>`;
